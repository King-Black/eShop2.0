...
//		erVer.schreibeDaten();
	 ...
	 * @throws ArtikelNichtGefundenException wird geworfen, wenn ein Artikel nicht gefunden wird.
	 */
	public Rechnung kaufen(Kunde k) throws NichtGenugAufLagerException, WarenkorbLeerException, ArtikelNichtGefundenException{
