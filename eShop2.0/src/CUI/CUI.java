...
public class CUI {
	...
	private void menueNichtEingeloggt(){
	...
	private void artikelmengeAendern(){
		System.out.println("Artikelliste:");
		gibArtikellisteAus();
